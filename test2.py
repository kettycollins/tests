def get_permutation_order(phrase):
    """Generates the permutation order based on the key phrase."""
...
def encrypt_double_permutation(text, key1, key2):
    """Encrypts the text using double permutation."""
...
def decrypt_double_permutation(encrypted_text, key1, key2):
    """Decrypts the text using double permutation."""
    # Generate permutation order for both keys
    order1 = get_permutation_order(key1)
    order2 = get_permutation_order(key2)
...
if __name__ == "__main__":
    ...
    # Key phrases for simple permutation
    key_phrase_simple = "SECRET"
    permutation_order = get_permutation_order(key_phrase_simple)

    # Encrypt and decrypt using simple permutation
    encrypted_text_simple = encrypt(original_text, permutation_order)
    print("Encrypted text using simple permutation:")
    print(encrypted_text_simple)

    decrypted_text_simple = decrypt(encrypted_text_simple, permutation_order)
    print("\nDecrypted text using simple permutation:")
    print(decrypted_text_simple)

    # Keys for double permutation
    key1 = "SECRET"
    key2 = "CRYPTO"

    # Encrypt and decrypt using double permutation
    encrypted_text_double = encrypt_double_permutation(original_text, key1, key2)
    print("\nEncrypted text using double permutation:")
    print(encrypted_text_double)

    decrypted_text_double = decrypt_double_permutation(encrypted_text_double, key1, key2)
    print("\nDecrypted text using double permutation:")
